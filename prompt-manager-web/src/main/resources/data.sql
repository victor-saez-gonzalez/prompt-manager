...
('11111111-1111-1111-1111-111111111111', 'Utilities', 'Tools and helpers'),
('22222222-2222-2222-2222-222222222222', 'Creativity', 'Writing and art prompts'),
('33333333-3333-3333-3333-333333333333', 'Productivity', 'Time management and focus'),
('44444444-4444-4444-4444-444444444444', 'Health', 'Fitness, nutrition, and wellness'),
('55555555-5555-5555-5555-555555555555', 'Technology', 'Programming, gadgets, and innovation'),
('66666666-6666-6666-6666-666666666666', 'Travel', 'Adventure, trips, and destinations'),
('77777777-7777-7777-7777-777777777777', 'Lifestyle', 'Home, habits, and personal growth'),
('88888888-8888-8888-8888-888888888888', 'Business', 'Entrepreneurship, startups, and finance'),
('99999999-9999-9999-9999-999999999999', 'Education', 'Learning, courses, and resources'),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Entertainment', 'Movies, games, and hobbies');
